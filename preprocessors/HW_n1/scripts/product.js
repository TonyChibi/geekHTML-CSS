...
function addProduct(element, product) {
    ...
    btnBox.classList.add('cart-button-box');
    imgBox.appendChild(btnBox);

    let btn = document.createElement("button");
    btn.classList.add("cart-button");
    btn.textContent = "Add to Cart";
    btn.insertAdjacentHTML("afterbegin", `<svg width="27" height="25" viewBox="0 0 27 25" fill="#fff"
    ...
    descr.classList.add("product-card__description");
